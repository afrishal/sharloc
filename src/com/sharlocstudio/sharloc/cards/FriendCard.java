...
public class FriendCard extends Card {
	...
	protected String friendAddress;
	...
	public void setFriendAddress(String address) {
	...
	public void createCard() {
		...
		header.setPopupMenu(R.menu.menu_card_friend,
				new CardHeader.OnClickCardHeaderPopupMenuListener() {
					@Override
					public void onMenuItemClick(BaseCard card, MenuItem item) {
						// Toast.makeText(getActivity().getApplicationContext(),
						// "Click on card menu" + mTitleHeader +" item=" +
						// item.getTitle(), Toast.LENGTH_SHORT).show();
						switch (item.getItemId()) {
						case R.id.menu_friend_show_location:
							// pass object friend
							if (friendLatitude != null
	...
	public void setupInnerViewElements(ViewGroup parent, View view) {
		...
		imageView.setImageResource(R.drawable.logo_developer); // GAMBAR DUMMY,
																// HAPUS AJA
																// NANTI
		imageView.setImageBitmap(bitmap); // GANTI BITMAP DI SINI (set dulu
											// objek bitmap-nya pake method
											// setCardImageBitmap(Bitmap bitmap)
											// di atas)
	...
	private void requestLocation() {
		RequestLocationServerComm reqLocation = new RequestLocationServerComm(
				friendsFragment);
	...
	private void removeFriend() {
		RemoveFriendServerComm remFriend = new RemoveFriendServerComm(
				friendsFragment);
		String email = friendsFragment.getUserEmail();
		List<NameValuePair> params = new ArrayList<NameValuePair>();
